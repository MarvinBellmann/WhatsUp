...
public class ChatFenster {
	...
	frame.setBounds(HauptFenster.frame.getX()-464, HauptFenster.frame.getY(), 452, 339);
	...
	label.setIcon(new ImageIcon(ChatFenster.class.getResource("/data/2.png")));
	label.setBounds(358, 31, 69, 69);
	frame.getContentPane().add(label);
	
	JLabel ichbild_lbl = new JLabel("");
	ichbild_lbl.setIcon(new ImageIcon(ChatFenster.class.getResource("/data/1.jpg")));
